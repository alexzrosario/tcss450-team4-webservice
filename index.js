...
/*
 * This middleware function parses JSON in the body of any requests
 */
...
app.use('/hourlyForecast', middleware.checkToken, require('./routes/hourlyForecast.js'))
app.use('/addContact', require('./routes/addContact.js'))
...
app.get("/", (request, response) => {
    ...
    for (i = 1; i < 7; i++) {
        ...
        response.write('<h' + i + ' style="color:blue">Hello World Version 2.0!</h' + i + '>'); 
    }
